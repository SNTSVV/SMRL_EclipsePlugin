 ...
 */
package lu.svv.lang.ide.contentassist.antlr;

import com.google.common.collect.ImmutableMap;
import com.google.inject.Inject;
import com.google.inject.Singleton;
import java.util.Map;
import lu.svv.lang.ide.contentassist.antlr.internal.InternalSMRLParser;
import lu.svv.lang.services.SMRLGrammarAccess;
import org.eclipse.xtext.AbstractElement;
import org.eclipse.xtext.ide.editor.contentassist.antlr.AbstractContentAssistParser;

public class SMRLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(SMRLGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SMRLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getSMRLAccess().getGroup(), "rule__SMRL__Group__0");
			...
			builder.put(grammarAccess.getSMRLAccess().getImportSectionAssignment_0(), "rule__SMRL__ImportSectionAssignment_0");
			builder.put(grammarAccess.getSMRLAccess().getElementsAssignment_1(), "rule__SMRL__ElementsAssignment_1");
			...
			builder.put(grammarAccess.getOperationAccess().getBodyAssignment(), "rule__Operation__BodyAssignment");
	...
	@Override
	protected InternalSMRLParser createParser() {
		InternalSMRLParser result = new InternalSMRLParser(null);
