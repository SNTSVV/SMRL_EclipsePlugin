...
import lu.svv.lang.ide.contentassist.antlr.PartialSMRLContentAssistParser;
...
import lu.svv.lang.ui.contentassist.SMRLProposalProvider;
import lu.svv.lang.ui.editor.SMRLEditor;
import lu.svv.lang.ui.labeling.SMRLDescriptionLabelProvider;
import lu.svv.lang.ui.labeling.SMRLLabelProvider;
import lu.svv.lang.ui.outline.SMRLOutlineTreeProvider;
import lu.svv.lang.ui.quickfix.SMRLQuickfixProvider;
import lu.svv.lang.validation.SMRLValidatorConfigurationBlock;
...
/**
 * Manual modifications go to {@link SMRLUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractSMRLUiModule extends DefaultXbaseUiModule {

	public AbstractSMRLUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(lu.svv.lang.parser.antlr.internal.InternalSMRLLexer.class);
	}
	...
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalSMRLLexer.class).toProvider(LexerProvider.create(InternalSMRLLexer.class));
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.validation.ValidatorFragment2
	public Class<? extends AbstractValidatorConfigurationBlock> bindAbstractValidatorConfigurationBlock() {
		return SMRLValidatorConfigurationBlock.class;
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return SMRLLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(SMRLDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return SMRLOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return SMRLQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return SMRLProposalProvider.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialSMRLContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("SMRL Compare");
	}
