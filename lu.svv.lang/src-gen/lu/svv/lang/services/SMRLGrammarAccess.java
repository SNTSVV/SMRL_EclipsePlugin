...
@Singleton
public class SMRLGrammarAccess extends AbstractGrammarElementFinder {
	
	public class SMRLElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "lu.svv.lang.SMRL.SMRL");
	...
	public class AbstractElementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "lu.svv.lang.SMRL.AbstractElement");
	...
	public class PackageDeclarationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "lu.svv.lang.SMRL.PackageDeclaration");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class EntityElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "lu.svv.lang.SMRL.Entity");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cMRKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final Assignment cNameAssignment_1 = (Assignment)cGroup.eContents().get(1);
		...
		//'MR' name=ValidID ('extends' superType=JvmTypeReference)? '{' features+=Feature* '}'
		public Group getGroup() { return cGroup; }
		
		//'MR'
		public Keyword getMRKeyword_0() { return cMRKeyword_0; }
	...
	public class FeatureElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "lu.svv.lang.SMRL.Feature");
	...
	public class PropertyElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "lu.svv.lang.SMRL.Property");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class OperationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "lu.svv.lang.SMRL.Operation");
	...
	private final SMRLElements pSMRL;
	...
	@Inject
	public SMRLGrammarAccess(GrammarProvider grammarProvider,
			XbaseGrammarAccess gaXbase,
			XtypeGrammarAccess gaXtype) {
		this.grammar = internalFindGrammar(grammarProvider);
		this.gaXbase = gaXbase;
		this.gaXtype = gaXtype;
		this.pSMRL = new SMRLElements();
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("lu.svv.lang.SMRL".equals(grammar.getName())) {
				return grammar;
			}
	...
	//	importSection=XImportSection?
	//	elements+=AbstractElement*;
	public SMRLElements getSMRLAccess() {
		return pSMRL;
	}
	
	public ParserRule getSMRLRule() {
		return getSMRLAccess().getRule();
	}
